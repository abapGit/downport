...
DATA lt_hashed TYPE temp7.
  ...
  METHOD to_abap_compressed_stdrd.
    ...
    TYPES temp8 TYPE STANDARD TABLE OF ty_foo_bar.
DATA lt_foo_bar TYPE temp8.
...
DATA lt_foo_bar TYPE temp10.
  ...
  METHOD to_abap_compressed_sort_unique.
    ...
    TYPES temp11 TYPE SORTED TABLE OF ty_foo_bar WITH UNIQUE KEY foo.
...
CLASS ltcl_integrated IMPLEMENTATION.
  ...
  METHOD array_index.
    ...
    TYPES temp14 TYPE TABLE OF ty_loc.
DATA lt_act TYPE temp14.
    TYPES temp15 TYPE TABLE OF ty_loc.
DATA lt_exp TYPE temp15.
...
CLASS ltcl_abap_to_json IMPLEMENTATION.
  ...
  METHOD set_array.
    ...
    TYPES temp16 TYPE TABLE OF ty_struc.
...
CLASS ltcl_filter_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    TYPES temp17_9418cd8b8d TYPE TABLE OF ty_visit_history.
DATA mt_visit_history TYPE temp17_9418cd8b8d.
