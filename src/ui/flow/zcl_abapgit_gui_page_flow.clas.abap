...
* its only remote, so there is no changes to stage
  ...
  METHOD build_sort_order_dropdown.
    ...
    temp3 = boolc( lv_current_sort = c_sort_order-default ).
    ro_toolbar->add(
      iv_txt = 'Default'
      iv_chk = temp3
    ...
    temp4 = boolc( lv_current_sort = c_sort_order-transport_descend ).
    ro_toolbar->add(
  ...
  METHOD zif_abapgit_gui_event_handler~on_event.
    ...
    CASE ii_event->mv_action.
      ...
      WHEN c_action-hide_full_matches.
        ...
        temp5 = boolc( ms_user_settings-hide_full_matches <> abap_true ).
        ms_user_settings-hide_full_matches = temp5.
        zcl_abapgit_persist_factory=>get_user( )->set_flow_settings( ms_user_settings ).
        rs_handled-state = zcl_abapgit_gui=>c_event_state-re_render.
      WHEN c_action-hide_conflicts.
        DATA temp6 TYPE xsdboolean.
        temp6 = boolc( ms_user_settings-hide_conflicts <> abap_true ).
        ms_user_settings-hide_conflicts = temp6.
        zcl_abapgit_persist_factory=>get_user( )->set_flow_settings( ms_user_settings ).
        rs_handled-state = zcl_abapgit_gui=>c_event_state-re_render.
      WHEN c_action-show_details.
        DATA temp7 TYPE xsdboolean.
        temp7 = boolc( ms_user_settings-show_details <> abap_true ).
        ms_user_settings-show_details = temp7.
        zcl_abapgit_persist_factory=>get_user( )->set_flow_settings( ms_user_settings ).
        rs_handled-state = zcl_abapgit_gui=>c_event_state-re_render.
      WHEN c_action-hide_matching_files.
        DATA temp8 TYPE xsdboolean.
        temp8 = boolc( ms_user_settings-hide_matching_files <> abap_true ).
        ms_user_settings-hide_matching_files = temp8.
        zcl_abapgit_persist_factory=>get_user( )->set_flow_settings( ms_user_settings ).
        rs_handled-state = zcl_abapgit_gui=>c_event_state-re_render.
