  ...
  METHOD zif_abapgit_gui_event_handler~on_event.
    ...
    CASE ii_event->mv_action.
      ...
      WHEN c_actions-toggle_hidden_chars. " Toggle display of hidden characters
        ...
        temp3 = boolc( ms_view-hidden_chars = abap_false ).
        ms_view-hidden_chars = temp3.

      WHEN c_actions-toggle_ignore_indent. " Toggle ignore indentation

        DATA temp4 TYPE xsdboolean.
        temp4 = boolc( ms_view-ignore_indent = abap_false ).
        ms_view-ignore_indent = temp4.

      WHEN c_actions-toggle_ignore_comments. " Toggle ignore comments

        DATA temp5 TYPE xsdboolean.
        temp5 = boolc( ms_view-ignore_comments = abap_false ).
        ms_view-ignore_comments = temp5.

      WHEN c_actions-toggle_ignore_case. " Toggle case sensitivity

        DATA temp6 TYPE xsdboolean.
        temp6 = boolc( ms_view-ignore_case = abap_false ).
        ms_view-ignore_case = temp6.
