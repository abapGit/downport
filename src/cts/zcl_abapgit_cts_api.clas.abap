...
* avoid database lookups in TLOCK for each item,
  ...
  METHOD zif_abapgit_cts_api~list_open_requests_by_user.
    ...
    TYPES: BEGIN OF ty_e070,
           ...
           END OF ty_e070.
    TYPES temp5 TYPE STANDARD TABLE OF ty_e070 WITH DEFAULT KEY.
DATA lt_e070 TYPE temp5.
...
* find all tasks first
  ...
  METHOD zif_abapgit_cts_api~list_open_requests.
    ...
    TYPES: BEGIN OF ty_e070,
             ...
             strkorr    TYPE e070-strkorr,
           END OF ty_e070.
    TYPES temp6 TYPE STANDARD TABLE OF ty_e070 WITH DEFAULT KEY.
DATA lt_e070 TYPE temp6.
...
* find all tasks first
  ...
  METHOD zif_abapgit_cts_api~list_r3tr_by_request.
    ...
    TYPES temp7 TYPE STANDARD TABLE OF trkorr WITH DEFAULT KEY.
DATA lt_tasks    TYPE temp7.
    TYPES temp8 TYPE STANDARD TABLE OF ty_contents WITH DEFAULT KEY.
DATA lt_contents TYPE temp8.
