...
CLASS ltcl_determine_max_processes IMPLEMENTATION.
  ...
  METHOD given_parallel_proc_disabled.
    ...
    CREATE OBJECT lo_settings_double EXPORTING iv_parallel_proc_disabled = iv_parallel_proc_disabled.
  ...
  METHOD given_is_merged.
    ...
    CREATE OBJECT lo_environment_double EXPORTING iv_is_merged = iv_is_merged.
